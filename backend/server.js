...
export function buildExecutorSystemPrompt(currentQuestion, allowedActions = [], questionContext = {}) {
    ...
    return [
      ...
      `- ${isBackgroundQuestion ? 'BACKGROUND QUESTIONS: Collect basic information and move to next question after any response. Do NOT ask follow-up questions. IMPORTANT: Do NOT say "Thank you for sharing" or similar acknowledgments - directly ask the next question.' : 'MAIN QUESTIONS: Be concise and conversational, one focused follow-up at a time; warm, curious, neutral.'}`,
      ...
      `  "utterance": "${isBackgroundQuestion ? 'Directly ask the next question without saying "Thank you for sharing" or similar acknowledgments' : 'ONE natural question OR a brief summary'}",`,
